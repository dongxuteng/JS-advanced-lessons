...
console.log(Object.prototype.hasOwnProperty("toString"));//这个方法可以用来检测一个对象是否含有特定的自身属性；和 in 运算符不同，该方法会忽略掉那些从原型链上继承到的属性。

console.log(foo.hasOwnProperty("valueOf"));
console.log(Object.prototype.hasOwnProperty("valueOf"));    //valueOf() 方法可返回 Boolean 对象的原始值。